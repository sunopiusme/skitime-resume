    ...
    <main id="main" tabIndex={-1} className={caseStyles.page}>
      ...
      <article className={caseStyles.article}>
        ...
        <section className={caseStyles.part}>
          ...
          <div className={caseStyles.wide}>
            <InlineFigure
              caption="Превью сайдбара ADE: два разрезa одной поверхности — сверху навигация и активные проекты, снизу хвост чатов и системный футер. Без прогресс-баров: работа видна как организованный список, а не как тревожный процесс."
              frame="plain"
            >
              <AgenticWorkflowLab />
            </InlineFigure>
