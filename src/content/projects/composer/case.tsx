    ...
    <main id="main" tabIndex={-1} className={caseStyles.page}>
      ...
      <article className={caseStyles.article}>
        ...
        <section className={caseStyles.part}>
          ...
          <div className={caseStyles.wide}>
            <InlineFigure
              caption="Превью сайдбара ADE: один сайдбар мысленно разрезан пополам и разложен в две колонки. Слева — верх, справа — низ; по линии реза половины уходят в фон. Без рамок, прогрессов и анимаций — только тихий ритм списка."
              frame="plain"
            >
              <AgenticWorkflowLab />
            </InlineFigure>
