      ...
      <article className={caseStyles.article}>
        ...
        <section className={caseStyles.part}>
          ...
          <div className={caseStyles.column}>
            <div className={caseStyles.prose}>
              <p>
                Дальше — не схема процесса, а сама поверхность. Тот же сайдбар разрезан пополам:
                одна половина показывает верх — нав, активные проекты и начало чатов, другая
                подхватывает хвост списка и системный футер. Между ними — пустота страницы,
                не разделитель.
              </p>
            </div>
          </div>
          ...
          <div className={caseStyles.wide}>
            <InlineFigure
              caption="Превью сайдбара ADE: организованный список проектов и чатов вместо тревожного прогресс-бара. Каждая половина уходит в фон — это один и тот же экран, поданный через разрез."
              frame="plain"
            >
              <AgenticWorkflowLab />
            </InlineFigure>
