...
export const frictionSignals: readonly FrictionSignal[] = [
  {
    ...
    score: 4,
    evidence:
      "Длинная сессия быстро перестает быть удобством и становится счетчиком стоимости запросов.",
  },
  {
    label: "риск доверия",
    shortLabel: "доверие",
    score: 5,
    evidence:
      "Без diff, тестов, трейса и явной приемки агент выглядит уверенно, но доверия у ревьюера не получает.",
  },
  {
    ...
    score: 4,
    evidence:
      "Агент может продолжать работать со старым контекстом и звучать так, будто все еще находится под контролем.",
  },
  {
    ...
    score: 3,
    evidence:
      "Широкие права без песочницы и подтверждений превращают скорость агента в операционный риск.",
  },
  {
    ...
    score: 5,
    evidence:
      "Автономность не отменяет ревью. Она лишь переносит нагрузку в доказательства и проверку pull request.",
  },
  {
    ...
    score: 3,
    evidence:
      "Работа распадается между IDE, терминалом, браузером, GitHub, облаком и параллельными чатами.",
  },
] as const;
