...
/* ─── Push-сцена (только превью-обложка) ───────────────
   Питомец справа толкает слово COMPOSER влево «шагами»:
...
type Props = {
  ...
  voice?: VoiceWaveform;
  /** Спец-сцена для превью-обложки. "push" — питомец толкает слово
      COMPOSER бесконечной бегущей строкой. По умолчанию обычная
...
export default function LcdMarquee({
  ...
  useEffect(() => {
    ...
    /* ─── Push-сцена: питомец толкает COMPOSER ───────────
